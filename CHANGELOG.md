...
- Updated to floriday-supplier-client v0.4.0 (Floriday Supplier API 2026v1)
- Updated `FLORIDAY_BASE_URL` references to `suppliers-api-2026v1`

## [0.12.10] - 2025-03-27

### Added

- New `sync customer-offers` command to synchronize customer offers data from Floriday
